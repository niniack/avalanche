...
from avalanche.models.expert_gate import ExpertAutoencoder, ExpertGate, ExpertModel
from avalanche.training.plugins import EvaluationPlugin, LwFPlugin, SupervisedPlugin
